...
export default function Agreements() {
  ...
  const {
    ...
    requiredFields: ['platform_agreement', 'microschool_agreement']
  })
  ...
  const handleContinue = async () => {
    if (formData.platform_agreement && formData.microschool_agreement) {
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  type="checkbox"
                  checked={formData.platform_agreement}
            ...
            >
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  type="checkbox"
                  checked={formData.microschool_agreement}
                  onChange={(e) => handleAgreementChange('microschool_agreement', e.target.checked)}
                  className="mt-1 w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
                <span className="text-base text-[#222222]">
