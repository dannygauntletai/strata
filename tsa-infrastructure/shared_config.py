...
class TSAConfig:
    ...
    def get_log_group_names(self) -> Dict[str, str]:
        ...
        return {
            # API Gateway log groups (backward compatibility keys)
            'auth': self.get_log_group_name('passwordless', 'apigateway'),
            ...
            # API Gateway log groups (legacy keys)
            'auth_api': self.get_log_group_name('passwordless', 'apigateway'),
