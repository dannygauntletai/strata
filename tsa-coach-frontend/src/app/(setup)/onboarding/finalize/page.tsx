...
export default function Finalize() {
  ...
  useEffect(() => {
    const data: OnboardingData = {
      ...
      email: JSON.parse(localStorage.getItem('onboarding_candidate_info') || '{}').email || localStorage.getItem('onboarding_email') || 'debug@tsacoach.com',
  ...
  return (
    <div className="min-h-screen bg-white font-poppins pb-[88px]">
      ...
      <header className="px-10 py-5 flex justify-between items-center">
        ...
        <Link href="/onboarding/school-name">
      ...
      <ProgressFooter
        progressPercent={95}
        nextButtonText="Confirm & Complete Onboarding"
        buttonAction={handleConfirm}
        showBackButton={true}
        backButtonHref="/onboarding/background-check"
        nextButtonClassName="bg-gradient-to-r from-[#22c55e] to-[#16a34a] hover:from-[#16a34a] hover:to-[#15803d] text-white"
      />
    </div>
  )
} 