...
class TSAConfig:
    ...
    def get_log_group_names(self) -> Dict[str, str]:
        """Get standardized CloudWatch log group names as dictionary"""
        return {
            'coach': self.get_log_group_name('coach', 'apigateway'),
            'coach_api': self.get_log_group_name('coach', 'apigateway'),  # Backward compatibility
    ...
    def get_api_names(self) -> Dict[str, str]:
        """Get standardized API Gateway names as dictionary"""
        return {
            'coach': self.get_api_name('coach'),
            'coach_api': self.get_api_name('coach'),  # Backward compatibility
